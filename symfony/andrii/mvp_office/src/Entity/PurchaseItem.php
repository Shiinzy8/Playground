...
class PurchaseItem
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MVP_Office\Entity\Purchase", inversedBy="purchaseItems")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MVP_Office\Entity\Product")
     * @ORM\JoinColumn(nullable=false)
    ...
    /**
     * @ORM\ManyToOne(targetEntity="MVP_Office\Entity\Color")
     * @Groups({"purchase_item:read", "purchase_item:write", "purchase:write"})
     */
    private $color;
