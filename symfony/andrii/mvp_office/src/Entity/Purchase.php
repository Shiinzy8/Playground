...
/**
 * @ORM\Entity(repositoryClass="MVP_Office\Repository\PurchaseRepository")
 * @ORM\Table(name="andrii_mvp_office_category")
 * @ApiResource(
...
class Purchase
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="MVP_Office\Entity\PurchaseItem", mappedBy="purchase", orphanRemoval=true, cascade={"persist"})
     * @Groups({"purchase:read", "purchase:write"})
     */
