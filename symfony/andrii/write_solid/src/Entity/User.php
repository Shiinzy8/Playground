...
/**
 * @ORM\Entity(repositoryClass="Write_solid\Repository\UserRepository")
 * @ORM\Table(name="andrii_write_solid_user")
...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Write_solid\Entity\BigFootSighting", mappedBy="owner")
     */
    private $bigFootSightings;

    /**
     * @ORM\OneToMany(targetEntity="Write_solid\Entity\Comment", mappedBy="owner")
     */
    private $comments;
