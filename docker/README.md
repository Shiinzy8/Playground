...
* `db`: This is the MariaDB database container (can be changed to postgresql or whatever in `docker-compose.yml` file),
...
-----------------------------------------------------------------------------------------------------------
pg_mysql                            docker-entrypoint.sh --def ...   Up      0.0.0.0:3306->3306/tcp, 33060/tcp
pg_elasticsearch                    /usr/local/bin/docker-entr ...   Up      0.0.0.0:9200->9200/tcp, 9300/tcp
pg_kibana                           /usr/local/bin/dumb-init - ...   Up      0.0.0.0:81->5601/tcp
pg_logstash                         /usr/local/bin/docker-entr ...   Up      5044/tcp, 9600/tcp
pg_nginx                            nginx                            Up      443/tcp, 0.0.0.0:80->80/tcp
pg_php_fpm                          php-fpm7 -F                      Up      0.0.0.0:9000->9001/tcp
```
